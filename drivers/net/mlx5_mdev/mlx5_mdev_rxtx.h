...
struct mlx5_mdev_mr {
	LIST_ENTRY(mlx5_mdev_mr) next; /**< Pointer to the next element. */
	rte_atomic32_t refcnt; /*<< Reference counter. */
	uint32_t lkey; /*<< rte_cpu_to_be_32(mr->lkey) */
	uintptr_t start; /* Start address of MR */
	uintptr_t end; /* End address of MR */
	void *mr; /*<< Memory Region. */
	uint32_t key;
...
struct mlx5_rxq_ibv {
	...
	struct mlx5_mdev_mr *mr; /* Memory Region (for mp). */
};
...
struct mlx5_rxq_ctrl {
	...
	rte_atomic32_t refcnt; /* Reference counter. */
	struct mlx5_mdev_priv *priv; /* Back pointer to private data. */
...
int priv_rx_intr_vec_enable(struct mlx5_mdev_priv *priv);
void priv_rx_intr_vec_disable(struct mlx5_mdev_priv *priv);
int mlx5_rx_intr_enable(struct rte_eth_dev *dev, uint16_t rx_queue_id);
int mlx5_rx_intr_disable(struct rte_eth_dev *dev, uint16_t rx_queue_id);
struct mlx5_rxq_ibv *mlx5_priv_rxq_ibv_new(struct mlx5_mdev_priv *, uint16_t);
struct mlx5_rxq_ibv *mlx5_priv_rxq_ibv_get(struct mlx5_mdev_priv *, uint16_t);
int mlx5_priv_rxq_ibv_release(struct mlx5_mdev_priv *, struct mlx5_rxq_ibv *);
int mlx5_priv_rxq_ibv_releasable(struct mlx5_mdev_priv *, struct mlx5_rxq_ibv *);
int mlx5_priv_rxq_ibv_verify(struct mlx5_mdev_priv *);
struct mlx5_rxq_ctrl *mlx5_priv_rxq_new(struct mlx5_mdev_priv *, uint16_t,
					uint16_t, unsigned int,
					const struct rte_eth_rxconf *,
					struct rte_mempool *);
struct mlx5_rxq_ctrl *mlx5_priv_rxq_get(struct mlx5_mdev_priv *, uint16_t);
int mlx5_priv_rxq_release(struct mlx5_mdev_priv *, uint16_t);
int mlx5_priv_rxq_releasable(struct mlx5_mdev_priv *, uint16_t);
int mlx5_priv_rxq_verify(struct mlx5_mdev_priv *);
int rxq_alloc_elts(struct mlx5_rxq_ctrl *);
struct mlx5_ind_table_ibv *mlx5_priv_ind_table_ibv_new(struct mlx5_mdev_priv *,
						       uint16_t [],
						       uint16_t);
struct mlx5_ind_table_ibv *mlx5_priv_ind_table_ibv_get(struct mlx5_mdev_priv *,
						       uint16_t [],
						       uint16_t);
int mlx5_priv_ind_table_ibv_release(struct mlx5_mdev_priv *, struct mlx5_ind_table_ibv *);
int mlx5_priv_ind_table_ibv_verify(struct mlx5_mdev_priv *);
struct mlx5_hrxq *mlx5_priv_hrxq_new(struct mlx5_mdev_priv *, uint8_t *, uint8_t,
				     uint64_t, uint16_t [], uint16_t);
struct mlx5_hrxq *mlx5_priv_hrxq_get(struct mlx5_mdev_priv *, uint8_t *, uint8_t,
				     uint64_t, uint16_t [], uint16_t);
int mlx5_priv_hrxq_release(struct mlx5_mdev_priv *, struct mlx5_hrxq *);
int mlx5_priv_hrxq_ibv_verify(struct mlx5_mdev_priv *);
uint64_t mlx5_priv_get_rx_port_offloads(struct mlx5_mdev_priv *);
uint64_t mlx5_priv_get_rx_queue_offloads(struct mlx5_mdev_priv *);
...
int priv_tx_uar_remap(struct mlx5_mdev_priv *priv, int fd);
struct mlx5_txq_mdev *mlx5_priv_txq_mdev_new(struct mlx5_mdev_priv *, uint16_t);
struct mlx5_txq_mdev *mlx5_priv_txq_mdev_get(struct mlx5_mdev_priv *, uint16_t);
int mlx5_priv_txq_mdev_release(struct mlx5_mdev_priv *, struct mlx5_txq_mdev *);
int mlx5_priv_txq_mdev_releasable(struct mlx5_mdev_priv *, struct mlx5_txq_mdev *);
int mlx5_priv_txq_mdev_verify(struct mlx5_mdev_priv *);
struct mlx5_txq_ctrl *mlx5_priv_txq_new(struct mlx5_mdev_priv *, uint16_t,
					uint16_t, unsigned int,
					const struct rte_eth_txconf *);
struct mlx5_txq_ctrl *mlx5_priv_txq_get(struct mlx5_mdev_priv *, uint16_t);
int mlx5_priv_txq_release(struct mlx5_mdev_priv *, uint16_t);
int mlx5_priv_txq_releasable(struct mlx5_mdev_priv *, uint16_t);
int mlx5_priv_txq_verify(struct mlx5_mdev_priv *);
void txq_alloc_elts(struct mlx5_txq_ctrl *);
uint64_t mlx5_priv_get_tx_port_offloads(struct mlx5_mdev_priv *);
...
int priv_check_raw_vec_tx_support(struct mlx5_mdev_priv *, struct rte_eth_dev *);
int priv_check_vec_tx_support(struct mlx5_mdev_priv *, struct rte_eth_dev *);
int rxq_check_vec_support(struct mlx5_rxq_data *);
int priv_check_vec_rx_support(struct mlx5_mdev_priv *);
...
struct mlx5_mdev_mr *priv_txq_mp2mr_reg(struct mlx5_mdev_priv *priv, struct mlx5_txq_data *,
