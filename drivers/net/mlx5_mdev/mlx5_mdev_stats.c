 ...
 */
static int
priv_read_dev_counters(struct mlx5_mdev_priv *priv, uint64_t *stats)
{
 ...
 */
static int
priv_ethtool_get_stats_n(struct mlx5_mdev_priv *priv) {
 ...
 */
void
priv_xstats_init(struct mlx5_mdev_priv *priv)
{
	struct mlx5_xstats_ctrl *xstats_ctrl = &priv->xstats_ctrl;
	unsigned int i;
	unsigned int j;
 ...
 */
static int
priv_xstats_get(struct mlx5_mdev_priv *priv, struct rte_eth_xstat *stats)
{
	struct mlx5_xstats_ctrl *xstats_ctrl = &priv->xstats_ctrl;
	unsigned int i;
 ...
 */
static void
priv_xstats_reset(struct mlx5_mdev_priv *priv)
{
	struct mlx5_xstats_ctrl *xstats_ctrl = &priv->xstats_ctrl;
	unsigned int i;
	unsigned int n = xstats_n;
 ...
 */
int
mlx5_mdev_stats_get(struct rte_eth_dev *dev, struct rte_eth_stats *stats)
{
 ...
 */
void
mlx5_mdev_stats_reset(struct rte_eth_dev *dev)
{
	struct mlx5_mdev_priv *priv = dev->data->dev_private;
	unsigned int i;
	unsigned int idx;
 ...
 */
int
mlx5_mdev_xstats_get(struct rte_eth_dev *dev,
 ...
 */
void
mlx5_mdev_xstats_reset(struct rte_eth_dev *dev)
{
	struct mlx5_mdev_priv *priv = dev->data->dev_private;
	struct mlx5_xstats_ctrl *xstats_ctrl = &priv->xstats_ctrl;
	int stats_n;
 ...
 */
int
mlx5_mdev_xstats_get_names(struct rte_eth_dev *dev,
